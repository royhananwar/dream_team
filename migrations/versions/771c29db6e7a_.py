...
Revision ID: 771c29db6e7a
Revises: 
Create Date: 2018-04-24 22:01:46.012985
...
def upgrade():
    ...
    sa.Column('departmen_id', sa.Integer(), nullable=True),
    sa.Column('role_id', sa.Integer(), nullable=True),
    sa.Column('is_admin', sa.Boolean(), nullable=True),
    sa.ForeignKeyConstraint(['departmen_id'], ['departments.id'], ),
